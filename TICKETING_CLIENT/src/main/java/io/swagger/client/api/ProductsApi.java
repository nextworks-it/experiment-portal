...
public class ProductsApi {
    ...
    private com.squareup.okhttp.Call getProductsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getProductsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getProductsCall(null, null);
        return apiClient.execute(call);
    }

    /**
     * Finds available products that are susceptible for ticket association (asynchronously)
     * 
