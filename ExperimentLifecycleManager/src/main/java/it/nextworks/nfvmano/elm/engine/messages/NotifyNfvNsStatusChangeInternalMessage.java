...
public class NotifyNfvNsStatusChangeInternalMessage extends InternalMessage {
	...
	@JsonCreator
	public NotifyNfvNsStatusChangeInternalMessage(@JsonProperty("nfvNsiId") String nfvNsiId, 
			@JsonProperty("statusChange") NsStatusChange statusChange,
			@JsonProperty("successful") boolean successful) {
		this.type = InternalMessageType.NFV_NS_STATUS_CHANGE_NOTIFICATION;
