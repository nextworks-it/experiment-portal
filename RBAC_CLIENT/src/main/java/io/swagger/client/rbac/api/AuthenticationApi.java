...
@Component("io.swagger.client.rbac.api.AuthenticationApi")
...
public class AuthenticationApi {
     ...
     * 
     * 
     * <p><b>200</b> - Access and refresh token pair
     * <p><b>401</b> - Unauthorized
     * @param body The body parameter
     * @throws RestClientException if an error occurs while attempting to invoke the API

     */
    public void login(UserLogin body) throws RestClientException {
        Object postBody = body;
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling login");
        }
    ...
    public void logout() throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/logout").build().toUriString();
     ...
     * 
     * <p><b>201</b>
     * <p><b>400</b> - Bad request due to missing parameters
     * @param body The body parameter
     * @throws RestClientException if an error occurs while attempting to invoke the API

     */
    public void register(UserRegistration body) throws RestClientException {
        Object postBody = body;
